...
The file for this is `pi_greet.sh` inside of `speech-scripts`
...
**Refer to [Jon's repo](https://github.com/ironclock/Interactive-Lab-Hub/tree/Fall2023/Lab%203) for the fully updated code.** 
